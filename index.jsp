...
<body>
	...
	<section class="container">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">컴퓨터그래픽스&nbsp;<small>이고잉</small></div>
					<div class="col-4 text-right">
						종합 <span style="color: red;">A</span>
					</div>
				</div>
			...
			<div class="card-body">
				<h5 class="card-title">
					넘넘 잼써여!!&nbsp;<small>(2012년 봄학기)</small>
				</h5>
				<p class="card-text">강의가 물흐르듯이 잘 흘러가고 너무 이해하기 쉽습니다!!</p>
				<div class="row">
					<div class="col-9 text-left">
						성적<span style="color: red;">A</span>
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">알고리즘&nbsp;<small>이보람</small></div>
					<div class="col-4 text-right">
						종합 <span style="color: red;">A</span>
					</div>
				</div>
			...
			<div class="card-body">
				<h5 class="card-title">
					넘넘 좋아용!!!&nbsp;<small>(2018년 가을학기)</small>
				</h5>
				<p class="card-text">이만한 강의 못봤어용~~~!!!!!.</p>
				<div class="row">
					<div class="col-9 text-left">
						성적<span style="color: red;">A</span>
						널널<span style="color: red;">A</span>
						강의<span style="color: red;">A</span>
						<span style="color: green;">(추천: 159)</span>
					</div>
					<div class="col-3 text-right">
						<a onclick="return confirm('추천하시겠습니까?')" href="./likeAction.jsp?evaluationID=">추천</a>
						<a onclick="return confirm('삭제하시겠습니까?')" href="./deleteAction.jsp?evaluationID=">삭제</a>
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
			Copyright &copy; 2019이보람All Rights Reserved.
	</footer>
				...
				<div class="modal-body">
					<form action="./evaluationRegisterAction.jsp" method="post">
						...
						<div class="form-row">
							...
							<div class="form-group col-sm-4">
							<label>수강 학기</label>
								<select name="semesterDrive" class="form-control">
						...
						<div class="form-group">
							<label>제목</label>
							<input type="text" name="evaluationTitle" class="form-control" maxlenth="30">
						</div>
						<div>
							<label>내용</label>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="./reportAction.jsp" method="post">
						<div class="form-group">
							<label>신고 제목</label>
							<input type="text" name="reportTitle" class="form-control" maxlenth="30">
						</div>
						<div>
							<label>신고 내용</label>
